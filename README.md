...
Download the DeepSense 6G dataset from the [DeepVerse 6G Machine Learning Challenge](https://ieee-dataport.org/competitions/deepverse-6g-machine-learning-challenge) and place it in the root directory.
